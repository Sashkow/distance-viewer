...
async def get_graph():
    ...
    graph_data['relationship_type'] = model.relationship_type.get_name()
    print(f"[API] Graph data: {len(graph_data['nodes'])} nodes, {len(graph_data['links'])} links, type={graph_data['relationship_type']}")
    return graph_data
...
async def get_graph_mds():
    ...
    graph_data['relationship_type'] = model.relationship_type.get_name()
    print(f"[API] MDS graph data: {len(graph_data['nodes'])} nodes, {len(graph_data['links'])} links, type={graph_data['relationship_type']}")
